    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className="md:container md:mx-auto text-center my-4 text-2xl">
          Every Mile is a collection of Twitter bots (plus this site) that
          travel popular trails one mile at a time.
        </p>
        ...
        <div className={styles.grid}>
          <Link href="https://x.com/every_mile_at">
            <a
              title="Follow Every Mile Appalachian Trail on Twitter"
          ...
          <Link href="https://x.com/every_mile_brp">
            <a
              title="Follow Every Mile Blue Ridge Parkway on Twitter"
              className={styles.card}
            >
              <svg
                style={{ display: "inline" }}
          ...
          <Link href="https://x.com/every_mile_cdt">
            <a
              title="Follow Every Mile Continental Divide Trail on Twitter"
              className={styles.card}
            >
              <svg
                style={{ display: "inline" }}
